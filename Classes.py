...
class Pichau:
    ...
    def __get_link_pichau(self, soup, c, dict_temp):
    ...
    def __get_name_pichau(self, soup, c, dict_temp):
    ...
    def __get_price_pichau(self, soup, c, dict_temp):
    ...
    def search_product_pichau(self):
        ...
        if site.status_code != 200:
            ...
            while c < 5:
                dict_temp = {}
                self.__get_link_pichau(soup, c, dict_temp)
                self.__get_name_pichau(soup, c, dict_temp)
                self.__get_price_pichau(soup, c, dict_temp)
